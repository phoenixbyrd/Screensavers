...
button_install = PushButton(pipes, text="Install", align="left", command=lambda: sub.call('./3dpipes/install.run'))
...
button_install = PushButton(aurora, text="Install", align="left", command=lambda: sub.call('./aurora/install.run'))
...
button_install = PushButton(fireplace, text="Install", align="left", command=lambda: sub.call('./fireplace/install.run'))
...
button_install = PushButton(flurry, text="Install", align="left", command=lambda: sub.call('./flurry/install.run'))
...
button_install = PushButton(row3_box, text="Install", align="left", command=lambda: sub.call('./grassgames/install.run'))
...
button_install = PushButton(lcars_box, text="Install", align="left", command=lambda: sub.call('./lcars/install.run'))
...
button_isntall = PushButton(green_box, text="Install", align="left", command=lambda: sub.call('./retroscifigreen/install.run'))
...
button_install = PushButton(blue_box, text="Install", align="left", command=lambda: sub.call('./retroscifiblue/install.run'))
...
button_install = PushButton(starfield, text="Install", align="left", command=lambda: sub.call('./starfield/install.run'))
...
button_install = PushButton(stickmen, text="Install", align="left", command=lambda: sub.call('./stickmen/install.run'))
...
button_install = PushButton(badapple, text="Install", align="left", command=lambda: sub.call('./badapple/install.run'))
...
button_install = PushButton(tropicalfish, text="Install", align="left", command=lambda: sub.call('./tropicalfish/install.run'))
...
button_install = PushButton(ribbons, text="Install", align="left", command=lambda: sub.call('./ribbons/install.run'))
...
button_install = PushButton(mystify, text="Install", align="left", command=lambda: sub.call('./mystify/install.run'))
