...
#Install screensaver
cp RetroSciFi.scr "$HOME/.screensavers/drive_c/windows/"
cp Msvbvm60.dll "$HOME/.screensavers/drive_c/windows/"
cp screensaver.sh "$HOME/.screensavers/"
cp ./fonts/*.TTF "$HOME/.screensavers/drive_c/windows/Fonts"
...
WINEPREFIX="$HOME/.screensavers" wine "$HOME/.screensavers/drive_c/windows/RetroSciFi.scr" /s
